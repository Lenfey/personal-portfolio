    ...
    positions: [
      {
        ...
        content: [
          {
            text: "Network, system and cloud engineer in Geneva%0D%0A- Infrastructure maintenance (Switch, servers, VMWare virtualization, Hyper-V)%0D%0A- Data storage, hyper-converged systems (Simplivity, DFS, Veeam replication)%0D%0A- Coordination between services (network,dev, security)%0D%0A- Monitoring (PRTG, OpsGenie)%0D%0A- Load Balancing (Azure Gateway, Microsoft RDS)%0D%0A- Microsoft Office 365 Administration (SharePoint, Teams, Exchange Online)%0D%0A- System Administration (Active Directory, Veeam, Domain Controler, GPO, WSUS)%0D%0A- Network administrator (Firewall, VLAN, Switch)%0D%0A- Scripting (Bash, Powershell, Python)%0D%0A- Support 2nd level, 3rd level%0D%0A- Project management for small and medium business",
            link: "",
          },
        ],
      },
